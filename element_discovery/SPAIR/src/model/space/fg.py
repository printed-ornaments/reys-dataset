...
class SpaceFg(nn.Module):
    ...
    def forward(self, x, globel_step):
        ...
        #print(o_att.shape)
        #print(alpha_att.shape)
        #print(alpha_att_hat.shape)
        ...
        importance_map_full_res = spatial_transform(importance_map, z_where.view(B * arch.G ** 2, 4), (B*arch.G**2, 1, *arch.img_shape),
                                                    inverse=True)
        #print(importance_map_full_res.shape)        
        ...
        #print(importance_map_full_res_norm.shape)                
        # To full resolution
