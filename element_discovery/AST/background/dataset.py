...
def get_datasets(batch_size=env.batch_size):
    ...
    if env.dataset_name == "clevrtex" or env.dataset_name == "clevr":
        ...
        train_dataset = CLEVRTEX(
            env.full_dataset_path,  # Untar'ed
        ...
        if env.test_dataset_path is None:
            print(
                "warning : test dataset not defined, will use train dataset for tests"
            )
            test_dataset = train_dataset
        else:
            test_dataset = Image_dataset(
                env.test_dataset_path, env.GT_test_dataset_path
            )
